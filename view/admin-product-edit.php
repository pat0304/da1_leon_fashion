...
<div class="product-box">
                ...
                <div class="container">
                    <div class="flex-user-add d-flex flex-row">
                        <div class="col-8">
                            <div class=" mb-3 mt-2">
                                ...
                                <input type="text" id="disabledTextInput" class="form-control" name="name" placeholder="" value="<?=$data['sp']['name']?>">
                            </div>
                            <div class="mb-3 mt-2">
                                <label for="disabledTextInput" class="form-label"> <h5>Giá </h5></label>
                                <input type="number" id="disabledTextInput" class="form-control" name="price" placeholder="" value="<?=$data['sp']['price']?>">
                            </div>
                            <div class="mb-3 mt-2">
                                <label for="disabledTextInput" class="form-label"> <h5>Giá khuyến mãi</h5></label>
                                <input type="number" id="disabledTextInput" class="form-control" name="sale_price" placeholder="" value="<?=$data['sp']['sale_price']?>">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-4 p-4 pb-0">
                            <div class=" box-img">
                                <img src="img/<?=$data['sp']['img']?>" id="img" style="height: 100%;" alt="">
                            </div>
                            <div>
                    ...
                    <div class="mb-3 mt-2">
                        ...
                        <textarea type="text" id="disabledTextInput" class="form-control" style="height: 100px" name="mo_ta" placeholder="" ><?=$data['sp']['mo_ta']?></textarea>
                    </div>
